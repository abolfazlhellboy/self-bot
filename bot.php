...
function closeConnection($message = 'Source_Home Is Runinng...<br>@Source_Home')
{
...
// @Source_Home $MadelineProto->messages->editMessage(['peer' => $peer,'id' => $msg_id,'message' => 'YourID : '.$messag, 'parse_mode' => 'markdown']);
} else {
	if($type3 == 'user'){
